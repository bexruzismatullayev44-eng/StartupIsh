  ...
  return (
    <div className="h-screen dark:bg-gray-700">
      <div className="max-h-screen text-center p-10 bg-white dark:bg-gray-700! text-black dark:text-white!">
        ...
        <button
          onClick={handleLogin}
          className="btn mt-4 py-2 rounded-md   dark:bg-gray-700! text-black dark:text-white! hover:bg-black dark:hover:bg-gray-600! transition-all"
        >
          Kirish
        </button>
