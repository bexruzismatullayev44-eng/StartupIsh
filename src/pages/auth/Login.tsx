...
export default function Login() {
  ...
  <span className="text-gray-600 dark:text-gray-300! mb-6 block">Hisobingizga kiring</span>
  ...
  <p className="mt-4 text-gray-700 dark:text-gray-300!">
    Hisobingiz yo'qmi?{" "}
    <Link to="/register" className="text-blue-500 dark:text-blue-400! underline">
      Ro'yxatdan o'tish
    </Link>
  </p>
</div>
