...
const Header = () => {
  ...
  return (
    <div className="w-full h-181.25 bg-[url('/images/OrqaFon.png')] bg-black/60 bg-blend-multiply ">
            ...
            <ul className="flex gap-4 list-none">
              ...
              {currentUser?.role === "worker" && (
                <NavLink
                  to="/worker/orders"
                  className={({ isActive }) =>
                    `px-2 py-1 no-underline! transition-color! ${
                      isActive
                        ? "text-blue-500 border-b-2 border-blue-500 dark:text-white!"
                        : "text-gray-800 border-b-2 border-transparent hover:text-blue-400 hover:border-blue-400 dark:text-white!"
                    }`
                  }
                >
                  Zakazlar
      ...
      <div className="w-full h-screen flex flex-col px-8 md:px-20 bg-cover bg-center bg-no-repeat">
        <div className="my-80 max-w-3xl">
          <h1 className="font-serif text-white font-bold leading-tight mb-6 tracking-wide">
            Zamonaviy uslub, <br /> sifatli tanlov
          </h1>
